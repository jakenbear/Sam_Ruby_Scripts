...
class Window_Base < Window
  ...
  def initialize(x, y, width, height)
    ...
    self.back_opacity = 150 # JAR EDIT
    update_padding
    update_tone
    create_contents
  ...
  def gauge_back_color;  text_color(15);  end;    # Gauge background
  #def hp_gauge_color1;   text_color(20);  end;    # HP gauge 1
  #def hp_gauge_color2;   text_color(21);  end;    # HP gauge 2
  def hp_gauge_color1;   text_color(1);  end;    # HP gauge 1
  def hp_gauge_color2;   text_color(9);  end;    # HP gauge 2
  ...
  def draw_gauge(x, y, width, rate, color1, color2)
    ...
    #contents.fill_rect(x, gauge_y, width, 24, gauge_back_color)
    #contents.gradient_fill_rect(x, gauge_y, fill_w, 24, color1, color2)
    
    # JAR COMMENTED OUT
    contents.fill_rect(110, 40, width, 24, gauge_back_color)
    contents.gradient_fill_rect(110, 40, fill_w, 24, color1, color2)
  end
  #--------------------------------------------------------------------------
  # * Draw Icon
  #     enabled : Enabled flag. When false, draw semi-transparently.
  ...
  def draw_actor_face(actor, x, y, enabled = true)
    ...
    #JAR - Draw but off screen
    #draw_face(actor.face_name, actor.face_index, x, 500, enabled)
  end
  #--------------------------------------------------------------------------
  # * Draw Name
  #--------------------------------------------------------------------------
  def draw_actor_name(actor, x, y, width = 112)
    ...
    # JAR COMMENTED OUT
    #draw_text(10, 100, width, line_height, actor.name)
  end
  #--------------------------------------------------------------------------
  # * Draw Class
  #--------------------------------------------------------------------------
  ...
  # * Draw HP
  #--------------------------------------------------------------------------
  def draw_actor_hp(actor, x, y, width = 232)
    draw_gauge(x, y, width, actor.hp_rate, hp_gauge_color1, hp_gauge_color2)
    change_color(system_color)
            
    #JAR COMMENTED OUT
    #draw_text(119, 26, 50, line_height, Vocab::hp_a)
    draw_text(114, 26, 50, line_height, "STAM") #JR edit
    #draw_text(x, y, 30, line_height, "") #JR edit
  ...
  def draw_actor_simple_status(actor, x, y)
   ...
   #draw_actor_class(actor, x + 120, y) #JR EDIT (STAMINA text)
  ...
  #--------------------------------------------------------------------------
  # * Draw Number (Gold Etc.) with Currency Unit CUSTOM
  #--------------------------------------------------------------------------
  def draw_currency_value_custom(unit, value, x, y, width)
    cx = text_size(unit).width
    change_color(normal_color)
    draw_text(x, y, width - cx - 2, line_height, value, 2)
    change_color(system_color)

...
$ki_keybinds= { #:N1 => [:trigger, :scene, Scene_Title],
                #:N2 => [:trigger, :var, 1, 5],
                #:N3 => [:trigger, :switch, 1],
                #:E => [:trigger, :switch, 2104],
                :F => [:trigger, :switch, 2105],  #CALL LOVER with F
                :N1 => [:trigger, :switch, 2103], #CELL HOT KEY
                :N2 => [:trigger, :script, "if !$game_switches[2104]\n SceneManager.call(Scene_Item)\n end"],
                :N3 => [:trigger, :script, "if !$game_switches[2104]\n SceneManager.call(Scene_Save)\n end"],
                #:N4 => [:trigger, :script, "if !$game_switches[2104]\n SceneManager.call(Scene_Options)\n end"],

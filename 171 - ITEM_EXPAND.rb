...
# see line 44.
custom_categories: [:item, :key_item, :food, :ingredients, :cards],
...
category_descriptions: {
  :all =>      "",
  :item =>     "Assorted Things",
  :weapon =>   "",
  :cards =>   "Vagabond Dog Indie Figure Collection",
  :food =>   "Ready To Eat",
  :ingredients => "Cook For Best Results",
  :armor =>    "",
  :key_item => "Stuff To Keep Close",
